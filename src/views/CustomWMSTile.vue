...
export default {
  mounted() {
    /**
     * OpenLayers不了解EPSG：21781（瑞士）的投影。
       因此，我们为EPSG：21781创建一个投影实例，并将其传递给ol / proj〜addProjection，以使其可用于库以通过其代码进行查找。
     */
    var projection = new Projection({
      code: "EPSG:21781",
      // 该范围用于确定缩放级别0。可以在https://epsg.io/上找到有关投影有效范围的建议值。
